...
class CrystalDataset(Dataset):
    ...
    @typecheck
    def _preprocess(self, save_path: str, preprocess_workers: int, prop: str) -> None:
    ...
    def _add_scaled_lattices_attr(self):
        """Add scaled lattice attributes to the dataset."""
    ...
    def __getitem__(self, index: int) -> Data:
        ...
        Returns:
            A Data object containing the sample.
        """
