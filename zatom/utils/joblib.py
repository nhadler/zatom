...
class ParallelTqdm(Parallel):
    ...
    Args:
        total_tasks: The number of expected jobs. Used in the tqdm progressbar.
        ...
        desc: The description used in the tqdm progressbar.
        disable_progressbar: If True, a tqdm progressbar is not used.
        show_joblib_header: If True, show joblib header before the progressbar.
    ...
    def __call__(self, iterable):
        """Call the parallel function on the given iterable."""
        try:
    ...
    def dispatch_one_batch(self, iterator):
        """Dispatch a single batch of tasks."""
...
def joblib_map(
    ...
    """Map a function over an iterable using joblib with progress tracking."""
