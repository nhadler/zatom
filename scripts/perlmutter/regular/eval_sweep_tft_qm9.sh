...
#SBATCH --time=00-24:00:00                                    # time limit for the job (up to 2 days: `02-00:00:00`)
...
#SBATCH --array=0-27                                          # create an array of jobs for the sweep (0-11 or 12 total for finetuning and 0-27 or 28 total for generative evaluation)
...
# Define run details
DEFAULT_SWEEP_ID="gmvln8u7"                   # NOTE: Generate a unique ID for each run by running `wandb sweep configs/sweep/{train,eval}_sweep_{joint,}.yaml`
