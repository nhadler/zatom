...
#SBATCH --array=0-55                                          # create an array of jobs for the sweep (0-11 or 12 total for finetuning and 0-55 or 56 total for generative evaluation)
...
# Define run details
DEFAULT_SWEEP_ID="wvm4yvyu"                   # NOTE: Generate a unique ID for each run by running `wandb sweep configs/sweep/{train,eval}_sweep_{joint,}.yaml`
