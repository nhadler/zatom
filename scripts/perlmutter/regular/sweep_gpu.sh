...
# Define run details
DEFAULT_SWEEP_ID="gd0h50vo"                   # NOTE: Generate a unique ID for each run by running `wandb sweep configs/sweep/{train,eval}_sweep_{joint,qm9,mp20,qmof150,omol25,geom}.yaml`
